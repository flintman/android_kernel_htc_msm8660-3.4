...
void __init shooter_gpio_mpp_init(void)
{
	...
	struct pm8xxx_gpio_init gpio_cfgs[] = {
          ...
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(SHOOTER_VOL_DN),
           ...
           /* PMIC ID interrupt */
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(SHOOTER_AUD_REMO_PRES),
                           PM_GPIO_DIR_IN, 0, 0, PM_GPIO_PULL_UP_1P5,
                           PM8058_GPIO_VIN_L5, 0, PM_GPIO_FUNC_NORMAL, 0, 0),
	};
