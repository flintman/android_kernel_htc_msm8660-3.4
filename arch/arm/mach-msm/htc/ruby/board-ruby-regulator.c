...
struct rpm_regulator_platform_data ruby_rpm_regulator_early_pdata __devinitdata = {
...
struct rpm_regulator_platform_data ruby_rpm_regulator_pdata __devinitdata = {
